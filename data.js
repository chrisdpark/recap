window.RECAP_DATA = {
  "updated": "Thursday, Sep 10, 2026 · 4:50 PM CT",
  "students": {
    "olen": {
      "name": "Olen",
      "attention": [
        "Bible 99.17% — Group Jigsaw- The Patriarchs overdue (Sep 3)",
        "Algebra I 44.58% — 1.1-1.4 Quiz = 2/20; Unit 1 Test = 23/100; Algebra Karaoke Performance overdue (Sep 3); Lesson 3: Solve and Color (schedule) overdue (Sep 2); Inequalities Mad Lib (schedule) overdue (Sep 8)",
        "German I 95.38% — Haben und Sein overdue (Sep 9); Lords Prayer Part 2 overdue (Sep 9); Haben/Sein HW Quiz due Sep 11",
        "World Geography 91.83% — September 9th - Current Event #1 due Sep 11; TURN IN - Human Environment Interaction Article Activity due Sep 11; Wednesday September 9th - Current Event #2 due Sep 11; submitted awaiting grade: TURN IN - 5 Themes of Geography Notes, TURN IN - Earth Stations and Guided Questions, TURN IN - Physical Processes Notes",
        "Biology 85.83% — Get to Know You Submission = 50/100; Pogil - Interpreting Data (in class) = 83/100; Biomolecules - Pogil (in class) overdue (Sep 4); Enzyme Station Rotation overdue (Sep 9); Creation Journals - Unit One overdue (Sep 9)",
        "English I 81% — SKDM Assessment = 70/100; Q1 Membean Quiz 1 = 80/100; Q1 Membean Program 3 overdue (Sep 9); TKAM Shoe Activity overdue (Sep 9); TKAM Ch. 8-12 In-Class Essay due Sep 10"
      ],
      "courses": [
        {
          "name": "Bible",
        ...
        },
        {
          ...
          "source": "Canvas",
          "grade": 95.38,
          "note": "95.38% — Vocab Quiz #1 Written = 36/40 — Haben und Sein overdue — Haben/Sein HW Quiz due Sep 11 — Lords Pra…",
          "work": [
            {
        ...
        },
        {
          ...
          "source": "Canvas",
          "grade": 91.83,
          "note": "91.83% — September 9th - Current Event #1 due Sep 11 — submitted awaiting grade: TURN IN - 5 Themes of Geog…",
          "work": [
            {
        ...
        },
        {
          ...
          "source": "Canvas",
          "grade": 85.83,
          "note": "85.83% — Get to Know You Submission = 50/100 — Pogil - Interpreting Data (in class) = 83/100 — Biomolecules…",
          "work": [
            {
        ...
        },
        {
          ...
          "source": "Canvas",
          "grade": 81,
          "note": "81% — Q1 Membean Program 3 overdue — TKAM Ch. 8-12 In-Class Essay due Sep 10",
          "work": [
            {
    ...
    "sky": {
      ...
      "courses": [
        ...
        },
        {
          ...
          "source": "Ethos",
          "grade": 100,
          "note": "4 overdue · 1 posted 0 · work due this week",
          "work": [
            {
        ...
        },
        {
          ...
          "work": [
            ...
            },
            {
              "title": "Test Unit 1",
              "status": "zero",
              "detail": "Posted 0, completed Sep 08",
              "due": "Due Sep 10"
            }
          ],
          "grades": [
